...
fpgen = AChem.GetMorganGenerator(radius=3, fpSize=4096, countSimulation=True) # Larger fpSize means less chance of colliding bits
...
df = pd.DataFrame(arr)
df.to_csv("count_array_fingerprint.csv", header=False, index=False)